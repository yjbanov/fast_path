...
/// Runs the fast_geometry [Matrix] benchmark suite against `package:vector_math`'s
/// `Matrix4` and reports per-op timings.
///
...
///
///   dart run benchmark/matrix_benchmark.dart            # table
///   dart run benchmark/matrix_benchmark.dart --json     # JSON
///
...
import 'src/matrix_catalog.dart';
